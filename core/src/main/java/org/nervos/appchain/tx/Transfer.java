...
public class Transfer extends ManagedTransaction {
    ...
    public static RemoteCall<TransactionReceipt> sendFunds(
            final AppChainj appChainj, Credentials credentials,
        ...
        final TransactionManager transactionManager = new RawTransactionManager(appChainj, credentials);

        return new RemoteCall<TransactionReceipt>(new Callable<TransactionReceipt>() {
            @Override
            public TransactionReceipt call() throws Exception {
                return new Transfer(appChainj, transactionManager).send(toAddress, value, unit);
            }
        });
    }
