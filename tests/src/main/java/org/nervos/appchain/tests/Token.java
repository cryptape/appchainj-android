 ...
 * <p>Please use the <a href="https://github.com/cryptape/appchainj-android/tree/master/codegen">codegen module</a> to update.
 *
 * <p>Generated with appchainj version 0.17.
 */
public class Token extends Contract {
    ...
    public static RemoteCall<Token> deploy(AppChainj appChainj, TransactionManager transactionManager, Long quota, BigInteger nonce, Long validUntilBlock, Integer version, String value, Integer chainId) {
